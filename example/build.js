...
getusermedia({ audio: true, video: false }, function (err, stream) {
  ...
  var rightmeter = volumemeter(ctx, function (volume) {
    ...
    console.log(document.getElementById("leftv").style.height)
    if (volume > 30) {
        alert("Estas hablando muy alto!")
    }
  })
...
},{"raf":6}],3:[function(require,module,exports){
...
},{"webrtc-adapter":8}],4:[function(require,module,exports){
(function (process){
...
},{"../utils":16,"./getusermedia":12,"sdp":7}],12:[function(require,module,exports){
/*
 *  Copyright (c) 2016 The WebRTC project authors. All Rights Reserved.
 *
 *  Use of this source code is governed by a BSD-style license
